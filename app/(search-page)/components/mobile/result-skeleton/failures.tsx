...
export function SimilarityWarning() {
  ...
  return (
    <div className="flex flex-col justify-between gap-6 rounded-b-4 bg-gradient-to-b from-light-surfaceBright/15 from-5% to-light-tertiaryContainer p-6 pt-12 text-light-onTertiaryContainer dark:from-dark-surfaceBright/15 dark:to-dark-tertiaryContainer dark:text-dark-onTertiaryContainer">
